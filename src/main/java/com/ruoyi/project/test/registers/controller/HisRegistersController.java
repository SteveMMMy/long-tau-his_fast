package com.ruoyi.project.test.registers.controller;
...
import com.ruoyi.project.test.registers.service.IHisRegistersService;
...
public class HisRegistersController extends BaseController
{
     ...
     * 查询挂号记录列表
     */
    @RequiresPermissions("test:registers:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出挂号记录列表
     */
    @RequiresPermissions("test:registers:export")
     ...
     * 新增保存挂号记录
     */
    @RequiresPermissions("test:registers:add")
     ...
     * 修改挂号记录
     */
    @RequiresPermissions("test:registers:edit")
     ...
     * 删除挂号记录
     */
    @RequiresPermissions("test:registers:remove")
