package com.ruoyi.project.his.procurement_plans.controller;
 ...
 */
@Controller
@RequestMapping("/his/procurement_plans")
public class HisProcurementPlansController extends BaseController
{
    private String prefix = "his/procurement_plans";

    @Autowired
    private IHisProcurementPlansService hisProcurementPlansService;

    @RequiresPermissions("his:procurement_plans:view")
    @GetMapping()
    public String procurement_plans()
    {
        return prefix + "/procurement_plans";
    }

    /**
     * 查询采购计划单列表
     */
    @RequiresPermissions("his:procurement_plans:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出采购计划单列表
     */
    @RequiresPermissions("his:procurement_plans:export")
     ...
     * 新增保存采购计划单
     */
    @RequiresPermissions("his:procurement_plans:add")
     ...
     * 修改采购计划单
     */
    @RequiresPermissions("his:procurement_plans:edit")
     ...
     * 删除采购计划单
     */
    @RequiresPermissions("his:procurement_plans:remove")
