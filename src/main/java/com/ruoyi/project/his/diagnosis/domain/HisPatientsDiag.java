 ...
 * @date 2024-05-17
 */
public class HisPatientsDiag extends BaseEntity
{
    ...
    /** 病历信息 */
    private List<HisMedicalRecord> hisMedicalRecordList;
    ...
    public List<HisMedicalRecord> getHisMedicalRecordList()
    {
        return hisMedicalRecordList;
    }

    public void setHisMedicalRecordList(List<HisMedicalRecord> hisMedicalRecordList)
    {
        this.hisMedicalRecordList = hisMedicalRecordList;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("hisMedicalRecordList", getHisMedicalRecordList())
            .toString();
    }
}
